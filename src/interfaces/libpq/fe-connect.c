...
static int	parseServiceFile(const char *serviceFile,
							 ...
							 PQExpBuffer errorMessage,
							 bool *group_found);
static int	parseServiceFileCurl(const char *serviceFile,
							 const char *service,
							 PQconninfoOption *options,
							 PQExpBuffer errorMessage,
							 bool *group_found);
...
parseServiceInfo(PQconninfoOption *options, PQExpBuffer errorMessage)
{
	...
	int			status;
	void	   *builtin_flow;
	int			(*parse_service_file_curl) (const char *serviceFile, const char *service, PQconninfoOption *options, PQExpBuffer errorMessage, bool *group_found);
	PGconn *conn;
	...
	if (strncmp(serviceFile, "http", 4) == 0){
